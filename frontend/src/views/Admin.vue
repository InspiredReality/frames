...
const userDetail = ref({}) // { [userId]: { walls, frames } }
  ...
  <div class="max-w-5xl mx-auto">
    ...
    <div v-else>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-dark-200 rounded-lg p-4 text-center col-span-2 sm:col-span-1">
            ...
            <div v-else-if="userDetail[user.id]">
              ...
              <div class="mb-4">
                ...
                <div class="space-y-2">
                  ...
                  >
                    <img
                      v-if="wall.thumbnail_path"
                      :src="getUploadUrl(wall.thumbnail_path)"
                    ...
                    <button
                      @click="deleteWall(wall.id, user.id)"
                      :disabled="deletingId === `wall-${wall.id}`"
                      class="text-red-400 hover:text-red-300 disabled:opacity-40 flex-shrink-0 p-1"
                      title="Delete wall"
                    >
              ...
              <div>
                ...
                <div class="space-y-2">
                  ...
                  >
                    <img
                      v-if="frame.thumbnail_path"
                      :src="getUploadUrl(frame.thumbnail_path)"
                      class="w-12 h-9 object-cover rounded flex-shrink-0"
                    />
                    ...
                    <button
                      @click="deleteFrame(frame.id, user.id)"
                      :disabled="deletingId === `frame-${frame.id}`"
                      class="text-red-400 hover:text-red-300 disabled:opacity-40 flex-shrink-0 p-1"
                      title="Delete frame"
                    >
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
